...
namespace Qiu.NetCore.NetCoreApp
{
    ...
    public class BaseController : Controller
    {
        ...
        protected SysUser UserDtoCache
        {
            get
            {
                GetMemoryCache.TryGetValue("user_" + UserDto?.UserId, out SysUser sys);
                return sys ?? UserDto;
            }
        }
        ...
        protected IActionResult RedirectToLocal(string returnUrl)
        {
            ...
            {
                return (IActionResult)Redirect(returnUrl);
            }
            else
            {
